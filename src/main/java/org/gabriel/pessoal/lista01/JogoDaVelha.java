...
public class JogoDaVelha {
    ...
    private static String verificaVencedor(char[][] matriz) {

        int valorLinha = verificaLinha(matriz);
        int valorColuna = verificaColuna(matriz);
        if (valorLinha != 0) {
            return "Houve vencedor na linha: " + valorLinha + "!";
        } else if (valorColuna != 0) {
            return "Houve vencedor na coluna: " + valorColuna + "!";
        } else if (verificaDiagonalPrincipal(matriz)) {
            return "Houve vencedor na diagonal principal!";
        } else if (verificaDiagonalSecundaria(matriz)) {
            return "Houve vencedor na diagonal secundária!";
        } else {
            return "Não houve vencedor!";
        }
    }
    /**
     * Jogo da Velha — Verificador de Vencedor<br><br>
     * Declare uma matriz char[3][3] já preenchida manualmente com 'X', 'O' e espaços vazios simulando um tabuleiro finalizado.<br><br>
     * Escreva a lógica que verifica se houve vencedor, checando:
     * - as 3 linhas
     * - as 3 colunas
     * - as 2 diagonais
     * Teste com pelo menos 3 tabuleiros diferentes (vitória em linha, em diagonal, e empate).<br><br>
    ...
    public static void main(String[] args) {
        ...
        System.out.println(verificaVencedor(matriz));
